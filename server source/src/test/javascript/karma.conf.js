...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/qrcode-generator/js/qrcode.js',
            'src/main/webapp/bower_components/qrcode-generator/js/qrcode_UTF8.js',
            ...
            'src/main/webapp/bower_components/angular-qrcode/angular-qrcode.js',
